-- ============================================================================
-- Schema Cơ sở dữ liệu RMN-Arms: Impression Recording Module
-- ============================================================================
-- Phiên bản: 1.0
-- Cập nhật lần cuối: 2026-01-23
-- Mô tả: Schema cơ sở dữ liệu đầy đủ for Impression Recording including
...
-- ============================================================================
-- BẢNG: impressions
-- Mô tả: Main impression tracking table with verification and quality metrics
...
-- Chỉ mục for HIGH VOLUME table - Optimized for query patterns
...
-- ============================================================================
-- BẢNG: impression_verification_logs
-- Mô tả: Detailed audit log of verification process for each impression
...
-- ============================================================================
-- BẢNG: impression_quality_metrics
-- Mô tả: Detailed quality metrics breakdown for each impression
...
-- ============================================================================
-- BẢNG: impression_disputes
-- Mô tả: Advertiser challenges to impression validity
...
-- ============================================================================
-- BẢNG: fraud_detection_rules
-- Mô tả: Configurable fraud detection rules
...
-- ============================================================================
-- BẢNG: device_reputation_history
-- Mô tả: Track device reputation changes over time
